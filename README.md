...
# Интерактивные курсы и игры для программистов

**Более 80 тренажёров, задачников и игр** — от Git и CSS до ассемблера, SQL, регулярных
выражений и слепой печати.

Всё, что учит кодом, а не видео: браузерные песочницы, головоломки и игры, где персонаж
управляется вашей программой.
...
* Указывайте язык интерфейса в скобках после ссылки: *(ru)*, *(en)*, *(multi)*.
* Одной строкой поясняйте, чем курс занимается и в какой форме идёт обучение.
* Добавляйте курс в подходящий раздел, а не в конец файла.
