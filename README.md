...
* [Devlands](https://devlands.com/) (en) – Игра для изучения Git в стиле Minecraft. В игре ветки Git стали коридорами, а коммиты — комнатами. Это позволяет визуально понимать структуру репозитория и осваивать работу с Git в интерактивной форме. Вы можете буквально «гулять» по своему репозиторию Git. Игра не бесплатная.
