...
* https://lost-at-sql.therobinlord.com/Lost at SQL (https://lost-at-sql.therobinlord.com/)
 Вы капитан тонующей подводной лодки. Удачи! Кстати, тут есть не только основной сюжет, но и доп.задания без подсказок, а также таблица лидеров.

* http://wwwlgis.informatik.uni-kl.de/extra/game/?lang=en
Вы оказываетесь на острове после авиакатастрофы и должны использовать свои навыки SQL, чтобы найти способ выбраться с него.

* https://sqlpd.com/
Подтягиваем базовый синтаксис и раскрываем преступления вместе с этой игрой. Данные для анализа вам предоставляет этичный хакер.

* https://datalemur.com/sql-game
Вы на том самом острове в качестве аналитика. И вам нужно рассчитать, например, количество порций, которое создаст «нужное напряжение» и прокормит лишь 90% игроков. Всего 9 уровней.
