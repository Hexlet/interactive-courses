...
* [Yeahub](https://yeahub.ru/questions) (ru) - база вопросов с собеседований по 20+ айтишным направлениям: Frontend, Backend, DevOps, QA и др. Есть фильтрация по навыкам и сложности. Каждый вопрос подробно разобран.
