...
* https://codesignal.com (en) - Набор задач на разные темы, алгоритмы базы данных, есть задачки для подготовки к собесам

### Игры для разработчиков

#### PHP
https://returntrue.win/ (en) - Прикольный набор головоломок из 16 уровней. Сложность возрастает постепенно. Для идеального решения нужно применять некоторые фишки/трюки языка. [Официальная документация в помщь](https://www.php.net/docs.php)
<details>
