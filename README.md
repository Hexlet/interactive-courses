...
* https://code.mu/ (ru, en) - Задачи разного уровня сложности для Java, JavaScript, PHP, C++ и других.
...
* #### Java
* https://codegym.cc/ (en) - CodeGym — это не просто учебный курс, это игра. Вы прокачиваете своего «игрового персонажа» до новых уровней, открываете новые квесты и получаете достижения. Начав, вы движетесь к конечной точке — к себе как к профессионалу в программировании.
* https://robocode.sourceforge.io/ (en) - Robocode — это игра по программированию, цель которой — разработать боевой робот-танк, способный сражаться с другими танками на языке Java. Бои роботов происходят в реальном времени и на экране.
